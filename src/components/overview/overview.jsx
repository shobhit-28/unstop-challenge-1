...
export const Overview = () => {
    const { isOverViewOpen, screenWidth } = useContext(StateHandlerContext)
    ...
    return (
        <div className={classNames("md:relative duration-1000", {
            ...
            <div className={classNames('text-[#1C4980] overflow-hidden duration-700 md:absolute md:w-[100%]', {
                'h-0': !isOverViewOpen,
                'h-full': isOverViewOpen
            })}>
                <p className="text-lg mb-4 font-medium">Assessments Overview</p>
                <div className="rounded-xl border border-[#DADCE0] xxl:flex grid-area">
                    ...
                    {/* candidates */}
                    <div className="py-4 px-5 border-r grow xl:border-0 div-2 md:border-b sm:p-2">
                        <p className="text-sm font-semibold mb-4 sm:mb-2">Candidates</p>
                        <div className="flex items-center gap-5 sm:gap-2 xs:gap-0">
                            {/* icon */}
                            <svg className='sm:mr-2' width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="">
                                <div className="flex items-center gap-1">
                                    <p className="text-xl font-bold">11,145</p>
                                    <p className="text-xs font-medium text-[#05C165]">+89</p>
                                </div>
                                <p className="text-xs font-medium">Total Candidate</p>
                            </div>
                            {/* partition */}
                            <svg className='xs:mx-2' width="2" height="40" viewBox="0 0 2 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 0V40" stroke="#DADCE0" />
                            </svg>
                            {/* attempted */}
                            <div className="">
                                <div className="flex items-center gap-1">
                                    <p className="text-xl font-bold">1,14</p>
                                    <p className="text-xs font-medium text-[#05C165]">+89</p>
                                </div>
                    ...
                    {screenWidth <= 1215 && <hr className='border-t w-full partition' />}
