    ...
    return (
        <div className='text-[#1C4980]'>
            ...
            <div className="rounded-xl border border-[#DADCE0] flex">
                ...
                {/* total assessment */}
                <div className="py-4 px-5 w-[10.125rem] border-r">
                ...
                {/* candidates */}
                <div className="py-4 px-5 border-r grow">
                    <p className="text-sm font-semibold mb-4">Candidates</p>
                ...
                {/* source */}
                <div className="py-4 px-5 border-r grow">
                    <p className="text-sm font-semibold mb-4">Candidates Source</p>
                    <div className="flex items-center gap-5">
                        {/* icon */}
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* total assessment */}
                <div className="py-4 pl-5 pr-[3.125rem] w-[11.75rem]">
