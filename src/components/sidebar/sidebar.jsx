...
export const Sidebar = () => {
    const { isSideBarOpen } = useContext(StateHandlerContext)
        ...
        <>
            {isSideBarOpen &&
                <div className="h-screen fixed gap-3 pt-4 pr-5 pb-5 pl-[1.875rem] bg-white">
                    ...
                    {/* assessment */}
                    <div className="bg-[#E5F1FC] border border-[#0073E6] w-[5.625rem] h-[4.375rem] flex items-center justify-center flex-col gap-[0.375rem] rounded-lg cursor-pointer">
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="text-xs text-[#0073E6]">Assessment</p>
                    </div>
                    ...
                    <div className="w-[5.625rem] h-[4.375rem] flex items-center justify-center flex-col gap-[0.375rem] rounded-lg cursor-pointer">
                        ...
                        <p className="text-xs">My Library</p>
                    </div>
                    ...
                    <p className="mt-4 text-xs m-auto text-center text-red-800 bg-red-200 py-1 px-2 w-3/5 rounded-3xl border-2 border-red-500">Admin</p>

                    <div className="w-[5.625rem] py-3 flex items-center justify-center flex-col gap-[0.375rem] rounded-lg cursor-pointer">
                        ...
                        <p className="text-xs text-center w-1/2">Round Status</p>
                    </div>
