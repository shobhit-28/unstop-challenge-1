...
export const Sidebar = () => {
    ...
    return (
        <div className={isSideBarOpen
            ...
            <div
                className="
                    h-screen fixed gap-3 pt-4 pr-5 pb-5 pl-[1.875rem] bg-white text-[#1C4980]
                ...
                ">
                    ...
                    <p className="text-xs font-medium text-[#0073E6]">Assessment</p>
                </div>
                ...
                <div className="md:flex md:flex-row-reverse md:justify-between md:items-center md:h-[3.125rem] md:pr-[0.625rem] md:w-full">
                    <p className="
                    mt-4 text-xs font-medium m-auto text-center text-[#D63500] bg-[#FBEBEA] py-[0.38rem] px-2 w-3/5 rounded-3xl border-2 border-[#D63500]
                    ...
                    md:h-[3.125rem] md:flex-row md:justify-start md:w-2/3 md:px-[0.625rem]">
                        ...
                        <p className="text-xs font-medium text-center w-1/2 md:w-full md:text-start">Round Status</p>
                    </div>
                </div>
