                ...
                {screenWidth <= 900 &&
                    <div className="flex">
...

                        {
                            isOverViewOpen
                                ?
                                <div className="w-10 h-10 p-1 cursor-pointer flex justify-center items-center border rounded-full bg-[#F2F8FE] border-[#0073E6]" onClick={() => setIsOverViewOpen(!isOverViewOpen)}>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2 18V7H6V18H2ZM8 18V2H12V18H8ZM14 18V11H18V18H14Z" fill="#0073E6" />
                                    </svg>
                                </div>
                                :
                                <div className="w-10 h-10 p-1 cursor-pointer flex justify-center items-center" onClick={() => setIsOverViewOpen(!isOverViewOpen)}>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex gap-[1.875rem] xl:flex-col">
                ...
                <div className="flex gap-[1.875rem] md:flex-col">
                    ...
                    {screenWidth >= 900
                        ...
                        :
                        Array(5).fill(<AssessmentCard num={324} />)
                    }
                    {screenWidth <= 900 && <AssessmentCard num={324090} />}
                </div>

                {screenWidth <= 900
                    &&
                    <button onClick={() => setIsAddAssessmentFormOpen(true)} className="fixed bottom-3 right-3 w-10 h-10 bg-[#0073e6] rounded-full text-white text-3xl flex justify-center items-center">
                        <BiPlus />
                    </button>}
