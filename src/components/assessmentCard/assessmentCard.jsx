    ...
    return (
        <div className="p-4 rounded-xl border border-[#DADCE0] lg:scale-90 lg:-m-5 md:scale-100 md:m-0">
            ...
            <div className="flex justify-between items-start sm:border-b-2 sm:border-dashed sm:pb-4 sm:mb-4">
                ...
                {/* right section */}
                <div className="">
                    <svg className="mb-[0.625rem]" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="">
                        ...
                        <p className="mb-[.125rem] text-lg font-medium">Math Assessment</p>
                ...
                {/* left section */}
                <div className="w-[1.875rem] h-[1.875rem] flex justify-center items-center">
            ...
            <div className="flex justify-between items-center xs:flex-col xs:items-start xs:gap-2">
                ...
                <div className="flex items-center gap-[.625rem]">
                    <button className="h-[1.875rem] py-[.125rem] pr-2 pl-[.375rem] flex justify-center items-center gap-1 border border-[#1C4980] rounded-3xl">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
